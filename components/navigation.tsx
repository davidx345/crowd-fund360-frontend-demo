"use client"
import { Heart, Home, Users, BarChart3, Shield, LogOut } from "lucide-react"
...
export default function Navigation({ currentPage, onNavigate, currentUser, setCurrentUser }: NavigationProps) {
  return (
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          <div className="flex items-center gap-8">
            <button
              onClick={() => onNavigate(currentUser ? currentPage : "home")}
